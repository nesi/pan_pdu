...
puts Pdu43V6145.new(ARGV[0], @auth.ibm_43V6145_PDU).current_power_usage
#Alternate method, using SNMP.
#puts Pdu43V6145.current_usage_snmp(ARGV[0], @auth.ibm_43V6145_PDU_community)
